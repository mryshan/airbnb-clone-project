...
2. SQL Join Exercises
This section contains the SQL queries for the specified join objectives. These queries should be executed in your SQL environment's query editor (e.g., the middle panel in DB-Fiddle) after the database schema has been successfully set up.

Content of database-adv-script/joins_queries.sql:
